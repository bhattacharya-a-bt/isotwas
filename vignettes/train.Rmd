...
```{r, train, message = F, warning=FALSE}
...
-   There are 6 total methods to predict expression. However, through simulations and real data examples, we recommend the four shown here as the default.
