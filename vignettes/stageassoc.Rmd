...
**Note**: Before running association tests, you need trained isoTWAS models. See the [Train an isoTWAS model](pipeline.html) vignette for instructions on training models using any of the 9 available prediction methods.
